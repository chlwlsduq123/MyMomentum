var Framer = {
        ...
        drawTick: function (x1, y1, x2, y2) {
            ...
            gradient.addColorStop(0, '#43C7FF');
            gradient.addColorStop(0.6, '#43C7FF');
        ...
        drawEdging: function () {
            this.context.save();
            this.context.beginPath();
            this.context.strokeStyle = 'rgba(67, 199, 255, 0.5)';
            this.context.lineWidth = 1;
    ...
    var Tracker = {
        ...
        drawArc: function () {
            this.context.save();
            this.context.strokeStyle = 'rgba(67, 199, 255, 0.8)';
            this.context.beginPath();
    ...
    var Scene = {
        ...
        canvasConfigure: function () {
            ...
            this.context.strokeStyle = '#43C7FF';
            this.calculateSize();
        },
    ...
    var Controls = {
        ...
        drawPic: function () {
            this.context.save();
            this.context.beginPath();
            this.context.fillStyle = 'rgba(67, 199, 255, 0.85)';
            this.context.lineWidth = 1;
